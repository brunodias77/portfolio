...
const WelcomeSection = () => {
    return (
        <section id="intro" className="flex container flex-col h-full justify-center mx-auto text-center py-7 gap-32 overflow-hidden ">
            <div className="flex w-full md:w-auto flex-col items-center justify-center  gap-28 lg:gap-32 lg:flex-row">
                ...
                <div className=" w-1/2 lg:w-2/6 flex-shrink-0 flex items-center justify-center">
